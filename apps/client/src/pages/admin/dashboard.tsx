...
import { Activity, AlertTriangle, RefreshCcw, Shield, Users } from "lucide-react";
                    ...
                    <div className="p-2 space-y-2 overflow-y-auto">
                      <div className="flex justify-between items-center p-2 bg-surface rounded">
                        ...
                        <span className="text-sm font-medium text-text-muted">
                          {metrics?.recentLoginActivity.last24h ?? 0}
                          {" "}
                          logins
                        </span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-surface rounded">
                        ...
                        <span className="text-sm font-medium text-text-muted">
                          {metrics?.recentLoginActivity.last7d ?? 0}
                          {" "}
                          logins
                        </span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-surface rounded">
                        ...
                        <span className="text-sm font-medium text-text-muted">
                          {metrics?.recentLoginActivity.last30d ?? 0}
                          {" "}
                          logins
                        </span>
                      </div>
                    ...
                    <div className="p-2 space-y-2 overflow-y-auto">
                      <div className="flex justify-between items-center p-2 bg-surface rounded">
                        ...
                        <span className="text-sm font-medium text-error">
                          {metrics?.failedLoginAttempts.last24h ?? 0}
                          {" "}
                          attempts
                        </span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-surface rounded">
                        <span className="text-sm text-text-muted">Last 7 Days</span>
                        <span className="text-sm font-medium text-error">
                          {metrics?.failedLoginAttempts.last7d ?? 0}
                          {" "}
                          attempts
                        </span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-surface rounded">
                        <span className="text-sm text-text-muted">Last 30 Days</span>
                        <span className="text-sm font-medium text-error">
                          {metrics?.failedLoginAttempts.last30d ?? 0}
                          {" "}
                          attempts
                        </span>
                      </div>
