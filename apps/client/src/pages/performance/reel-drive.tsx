...
export function mapBackendToFrontendReelDrive(backendData: any, prevReelDrive?: any) {
  const camel = snakeToCamel(backendData || {});
  return {
    referenceNumber: backendData.reference || backendData.referenceNumber || prevReelDrive?.referenceNumber || '',
    ...(prevReelDrive || {}),
    ...camel
  };
}
...
export default function ReelDrive() {
  const { performanceSheet, setPerformanceSheet, updatePerformanceSheet } = usePerformanceSheet();
  ...
  const handleGetData = async (refOverride?: string) => {
    const ref = refOverride || form.referenceNumber || performanceSheet.referenceNumber;
    if (!ref) {
  ...
  const handleSetData = async () => {
    ...
    try {
      await createReelDrive({ ...form, referenceNumber: form.referenceNumber || performanceSheet.referenceNumber });
    ...
    <div className="w-full flex flex-1 flex-col p-2 gap-2">
      ...
      <Card className="mb-0 p-4">
        ...
        <div className="grid grid-cols-2 gap-6">
          <Input label="Reference" name="referenceNumber" value={form.referenceNumber || performanceSheet.referenceNumber || ''} onChange={handleChange} required />
      ...
      <Card className="mb-0 p-4">
        <Text as="h3" className="mb-4 text-lg font-medium">Model & HP</Text>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Input label="Reel Model" name="reelModel" value={form.reelModel || ''} onChange={handleChange} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
        ...
        {/* MANDREL */}
        <Card className="p-4">
          <Text as="h3" className="mb-4 text-lg font-medium">Mandrel</Text>
          <div className="space-y-2">
        ...
        {/* BACKPLATE */}
        <Card className="p-4">
          <Text as="h3" className="mb-4 text-lg font-medium">Backplate</Text>
          <div className="space-y-2">
        ...
        {/* COIL */}
        <Card className="p-4">
          <Text as="h3" className="mb-4 text-lg font-medium">Coil</Text>
          <div className="space-y-2">
        ...
        {/* REDUCER */}
        <Card className="p-4">
          <Text as="h3" className="mb-4 text-lg font-medium">Reducer</Text>
          <div className="space-y-2">
        ...
        {/* CHAIN */}
        <Card className="p-4">
          <Text as="h3" className="mb-4 text-lg font-medium">Chain</Text>
          <div className="space-y-2">
        ...
        {/* TOTAL */}
        <Card className="p-4">
          <Text as="h3" className="mb-4 text-lg font-medium">Total</Text>
          <div className="space-y-2">
        ...
        {/* MOTOR */}
        <Card className="p-4">
          <Text as="h3" className="mb-4 text-lg font-medium">Motor</Text>
          <div className="space-y-2">
        ...
        {/* FRICTION */}
        <Card className="p-4">
          <Text as="h3" className="mb-4 text-lg font-medium">Friction</Text>
          <div className="space-y-2">
        ...
        {/* SPEED & ACCELERATION */}
        <Card className="p-4">
          <Text as="h3" className="mb-4 text-lg font-medium">Speed & Acceleration</Text>
          <div className="space-y-2">
        ...
        {/* TORQUE */}
        <Card className="p-4">
          <Text as="h3" className="mb-4 text-lg font-medium">Torque</Text>
          <div className="space-y-2">
        ...
        {/* HP REQ'D */}
        <Card className="p-4">
          <Text as="h3" className="mb-4 text-lg font-medium">HP Req'd</Text>
          <div className="space-y-2">
        ...
        {/* REGEN */}
        <Card className="p-4">
          <Text as="h3" className="mb-4 text-lg font-medium">Regen</Text>
          <div className="space-y-2">
        ...
        {/* NOTES */}
        <Card className="p-4">
          <Text as="h3" className="mb-4 text-lg font-medium">Notes</Text>
          <div className="space-y-2">
