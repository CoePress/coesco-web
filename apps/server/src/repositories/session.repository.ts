...
export class SessionRepository extends BaseRepository<Session> {
	...
	protected async validate(entity: SessionAttributes): Promise<void> {
		...
		if (!entity.loginAt) throw new BadRequestError("loginAt is required");
		if (!entity.lastActivityAt) throw new BadRequestError("lastActivityAt is required");
		...
		if (entity.isSuspicious === undefined || entity.isSuspicious === null) throw new BadRequestError("isSuspicious is required");
	}
