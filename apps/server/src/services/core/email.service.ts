  ...
  async sendBugReport(options: {
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #333; border-bottom: 2px solid #4F46E5; padding-bottom: 10px;">Bug Report</h2>
        ...
        <div style="margin: 20px 0;">
          <h3 style="color: #4F46E5; margin-bottom: 5px;">Description</h3>
          <p style="margin: 0; padding: 10px; background: #f5f5f5; border-radius: 4px; white-space: pre-wrap;">${description}</p>
        </div>

        ${userEmail ? `
        <div style="margin: 20px 0;">
          <h3 style="color: #4F46E5; margin-bottom: 5px;">Reported By</h3>
        ...
        ${url ? `
        <div style="margin: 20px 0;">
          <h3 style="color: #4F46E5; margin-bottom: 5px;">Page URL</h3>
        ...
        ${userAgent ? `
        <div style="margin: 20px 0;">
          <h3 style="color: #4F46E5; margin-bottom: 5px;">Browser</h3>
        ...
        ${screenshot ? `
        <div style="margin: 20px 0;">
          <h3 style="color: #4F46E5; margin-bottom: 5px;">Screenshot</h3>
