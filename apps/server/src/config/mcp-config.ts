...
export const SCHEMAS: ISchema[] = [
  ...
  {
    name: "cost-code",
    description: "Schema for CostCode entity",
    schema: {
      id: {
        type: "string",
        required: true,
  ...
  {
    name: "employee-hours",
    description: "Schema for EmployeeHours entity",
    schema: {
      id: {
        type: "string",
        required: true,
  ...
  {
    name: "job-code",
    description: "Schema for JobCode entity",
    schema: {
      id: {
        type: "string",
        required: true,
  ...
  {
    name: "shift-note",
    description: "Schema for ShiftNote entity",
    schema: {
      id: {
        type: "string",
        required: true,
